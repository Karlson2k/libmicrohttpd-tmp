...
#define _MHD_INVALID_CLOCK_T ((clock_t) -2)

static clock_t mono_clock_service = _MHD_INVALID_CLOCK_T;
...
#endif /* HAVE_CLOCK_GETTIME */
#ifdef HAVE_CLOCK_GET_TIME
  mono_clock_service = _MHD_INVALID_CLOCK_T;
#endif /* HAVE_CLOCK_GET_TIME */
...
{
#ifdef HAVE_CLOCK_GET_TIME
  if (_MHD_INVALID_CLOCK_T != mono_clock_service)
    {
      mach_port_deallocate(mach_task_self(), mono_clock_service);
      mono_clock_service = _MHD_INVALID_CLOCK_T;
    }
